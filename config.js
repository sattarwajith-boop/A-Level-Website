...
const SITE = {
  ...
  copyright: "© 2026 The Dark Room. Educational resources for Sri Lankan A/L students.",
  ...
  subjects: [
    ...
    { icon: "⚛️", color: "rgba(74,144,217,0.12)",    name: "Physics",                     meta: "Tamil · Sinhala · English", href: "#" },
  ...
  tools: [
    ...
    { icon: "📋", title: "Study Timetable Generator",  desc: "Build a personalized weekly revision plan based on your exam date and subjects." },
  ...
  subjectPage: {
    ...
    resources: [
      { icon: "📄", title: "2024 A/L Chemistry Past Paper — Tamil Medium (Paper I & II)", badges: [["amber","Official"],["blue","Past Paper"],["gray","Tamil"],["gray","2024"]], pages: "16", size: "4.2 MB · PDF", downloads: "PDF ready", source: "Dept. of Examinations SL" },
      { icon: "✅", title: "2024 A/L Chemistry Marking Scheme — Tamil Medium",            badges: [["amber","Official"],["green","Marking Scheme"],["gray","Tamil"],["gray","2024"]], pages: "22", size: "3.1 MB · PDF", downloads: "PDF ready", source: "Dept. of Examinations SL" },
      { icon: "📄", title: "2024 A/L Chemistry Past Paper — Sinhala Medium (Paper I & II)", badges: [["amber","Official"],["blue","Past Paper"],["gray","Sinhala"],["gray","2024"]], pages: "16", size: "4.0 MB · PDF", downloads: "PDF ready", source: "Dept. of Examinations SL" },
      { icon: "📘", title: "2024 A/L Chemistry Model Paper — e-Thaksalawa (English Medium)", badges: [["gray","e-Thaksalawa"],["green","Model Paper"],["gray","English"],["gray","2024"]], pages: "20", size: "2.8 MB · PDF", downloads: "PDF ready", source: "e-Thaksalawa MOE" },
      { icon: "📋", title: "A/L Chemistry Syllabus 2024 — NIE Sri Lanka (All Mediums)",   badges: [["amber","Official"],["purple","Syllabus"],["gray","All Mediums"]], pages: "48", size: "6.2 MB · PDF", downloads: "PDF ready", source: "NIE Sri Lanka" },
      { icon: "📄", title: "2023 A/L Chemistry Past Paper — Tamil Medium",                badges: [["amber","Official"],["blue","Past Paper"],["gray","Tamil"],["gray","2023"]], pages: "16", size: "3.9 MB · PDF", downloads: "PDF ready", source: "Dept. of Examinations SL" },
    ],
  },
  ...
  downloadPage: {
    ...
    officialBadge: "✓ Official — Dept. of Examinations SL",
    papers: [
      { name: "Paper I (MCQ)" },
    ...
    sidebar: {
      ...
      related: [
        { icon: "📄", title: "2023 A/L Chemistry Past Paper — Tamil Medium",  meta: "Past Paper · Tamil · 2023" },
        { icon: "📄", title: "2024 Chemistry Past Paper — Sinhala Medium",    meta: "Past Paper · Sinhala · 2024" },
        { icon: "📘", title: "2024 Chemistry Model Paper — e-Thaksalawa",     meta: "Model Paper · English · 2024" },
        { icon: "📋", title: "A/L Chemistry Syllabus 2024 — NIE",             meta: "Syllabus · All Mediums" },
      ],
      allChemistry: [
